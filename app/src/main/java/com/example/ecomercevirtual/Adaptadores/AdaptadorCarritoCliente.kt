...
import com.example.ecomercevirtual.databinding.ItemCarritoClienteBinding
...
class AdaptadorCarritoCliente : RecyclerView.Adapter<AdaptadorCarritoCliente.HolderProductoCarrito> {

    private lateinit var binding : ItemCarritoClienteBinding
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HolderProductoCarrito {
        binding = ItemCarritoClienteBinding.inflate(LayoutInflater.from(mContext),parent, false)
    ...
    private fun visualizarDescuento(modeloProductoCarrito: ModeloProductoCarrito, holder: AdaptadorCarritoCliente.HolderProductoCarrito) {
    ...
    private fun cargarPrimeraImg(modeloProductoCarrito: ModeloProductoCarrito, holder: AdaptadorCarritoCliente.HolderProductoCarrito) {
