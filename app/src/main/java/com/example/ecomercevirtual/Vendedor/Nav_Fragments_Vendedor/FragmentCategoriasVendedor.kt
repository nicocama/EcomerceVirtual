...
import com.example.ecomercevirtual.Adaptadores.AdaptadorCategoriaVendedor
import com.example.ecomercevirtual.Modelo.ModeloCategoria
import com.example.ecomercevirtual.R
import com.example.ecomercevirtual.databinding.FragmentCategoriasVendedorBinding
...
class FragmentCategoriasVendedor : Fragment() {
    ...
    private lateinit var adaptadorCategoriaV : AdaptadorCategoriaVendedor
    ...
    private fun listarCategorias() {
        ...
        ref.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                adaptadorCategoriaV = AdaptadorCategoriaVendedor(mContext, categoriasArrayList)
